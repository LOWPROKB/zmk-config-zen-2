...
Knucklehead is a mnemonic-rich, macOS-optimized, 42-key[^1] ergo/columnar keyboard layout, designed to ease the transition to this style of board for those coming from traditional Apple-style keyboard layouts.
